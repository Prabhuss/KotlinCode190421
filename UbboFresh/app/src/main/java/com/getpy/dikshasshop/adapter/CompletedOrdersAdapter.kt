...
class CompletedOrdersAdapter(val context: Context, var mCategoriesList:ArrayList<CustomerInvoiceData>,val itemClick:ItemClickListener) : RecyclerView.Adapter<CompletedOrdersAdapter.DeveloperViewHolder>() {
        ...
        RecyclerView.ViewHolder(mItemCategoryRowBinding.root)
    {
        ...
        init {
            ...
            mItemCategoryRowBinding.root.setOnClickListener(View.OnClickListener {
                itemClick.onItemClick(mItemCategoryRowBinding.root,adapterPosition)
            })
        }
    }
}