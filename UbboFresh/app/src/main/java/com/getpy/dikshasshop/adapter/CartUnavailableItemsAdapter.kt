...
class CartUnavailableItemsAdapter(val preference: PreferenceProvider, val fm:FragmentManager, val context: Context, var mCategoriesList:MutableList<ProductsDataModel>) : RecyclerView.Adapter<CartUnavailableItemsAdapter.DeveloperViewHolder>() {
    ...
    override fun onBindViewHolder(holder: DeveloperViewHolder, i: Int) {
        ...
        holder.mItemCategoryRowBinding.productPrice.text= "Unavailable"
        holder.mItemCategoryRowBinding.productPrice.setTextColor(context.resources.getColor(R.color.family_red))
        holder.mItemCategoryRowBinding.totPrice.visibility = View.GONE
        holder.mItemCategoryRowBinding.count.text= model.itemCount.toString()
        holder.mItemCategoryRowBinding.layout.visibility = View.GONE
